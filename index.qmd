...
*INSERT TEXT -- DELETE THIS TEXT WHEN DONE.* What effect (if any) does being the "home" team versus being the "away" team affect the teams' performances?
...
A correlation matrix is first used to find any potential relationships amongst thevariables of interest before any futher analysis is conducted.The variables of interest here are red cards, yellow cards,the card foul ratio and the full time goals. The correlation plot is designed to assign a higher color hue to the variables which havea relatively higher correlation. From the visualization, it is revealed that the most positively correlated variables of interest are yellow cards and the card foul ratio. This is followed by the yellow cards and the number of fouls. All other variables of interest seem to have verylittle correlation amongst them.
...
The density plot represents the distribution of the card foul ratio of the home and away teamsof the premier league data set.The card foul ratio represents the number of cards per fouls committed duringa match. This ratio helps to determine whether or not theb fouls committed are rather aggresive or not.A higher card foul ratio represents that a team may be playing more aggresively while a lower card foul ratio suggest theopposite.The visualization highlights the card foul ratio of home and away teams across various matches played in the premier league.From this density plot, it is rather evident that the card foul ratios of thehome team are on the higher side compared to that of the away team. One would believe that it would bethe opposite in this scenario and that the away team would have a higher card foul ratio due to a bias infavor of the home team. However this is clearly not the case. It rather appear that the home team has a higher card foul ratio and onecannot help but wonder if this is simply as a result of the home team feeling more confident and comfortable in their territory.In conclusion, home teams have a higher card foul ratio and play more aggresively during premier league matches compared to the away team.
